          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            >
              <p className="text-lg text-indigo-200/65">
                Open AI reads and understands your files, and with nothing more than a single line of feedback, so you
                can go further than the speed of thought.
              </p>
            </Spring>
          </div>
