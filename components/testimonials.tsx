...
import { animText } from '@/app/animations';
...
export default function Testimonials() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          >
            <p className="text-lg text-indigo-200/65">
              We provide tech-first solutions that empower decision-makers to build healthier and happier workspaces
              ...
              <div key={index} className="group">
                <Spring
                  ...
                  spring={{
                    ...
                    scale: {
                      values: { default: 1, enter: 1.2, down: 1.2, up:  1},
                      stiffness: 120,
                      damping: 10,
                      isMobile: true,
                    },
      ...
      /* большое мягкое пятно (аура / шлейф) */
      before:pointer-events-none before:absolute before:-left-40 before:-top-40 before:z-10
      before:h-80 before:w-80 before:rounded-full before:blur-3xl
      before:bg-indigo-500/80 before:opacity-0 before:transition-opacity before:duration-500
      before:translate-x-[var(--mouse-x)] before:translate-y-[var(--mouse-y)]
      before:will-change-transform before:will-change-filter

      /* маленькое яркое ядро (стержень/хвост тени) */
      after:pointer-events-none after:absolute after:-left-48 after:-top-48 after:z-30
      after:h-64 after:w-64 after:rounded-full after:blur-3xl
      after:bg-indigo-500 after:opacity-0 after:transition-opacity after:duration-500
      after:translate-x-[var(--mouse-x)] after:translate-y-[var(--mouse-y)]
      after:will-change-transform after:will-change-filter

      /* наведение: мягкое видно всегда, ядро слегка проявляется */
      group-hover/card:before:opacity-100 hover:after:opacity-20
                  "
                  >
                    {testimonial.content}
                  </Testimonial>
...
export function Testimonial({
  ...
  return (
    <article
      className={`${className} relative rounded-2xl bg-linear-to-br from-gray-900/50 via-gray-800/25 to-gray-900/50 p-5 backdrop-blur-xs transition-opacity before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:border before:border-transparent before:[background:linear-gradient(to_right,var(--color-gray-800),var(--color-gray-700),var(--color-gray-800))_border-box] before:[mask-composite:exclude_!important] before:[mask:linear-gradient(white_0_0)_padding-box,_linear-gradient(white_0_0)] ${
